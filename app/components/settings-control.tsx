...
export const SettingsControl = () => {
  ...
  const CustomOption = ({ children, ...props }: { children: React.ReactNode; innerProps: any }) => {
    ...
    <div className="p-4">
      ...
      {typeof text === "string" ? (
        <Input
          ...
          value={text}
          className="mb-4"
          onChange={(e) => setProp((props: { children: ReactNode }) => (props.children = e.target.value.replace(/<\/?[^>]+(>|$)/g, "")))}
        />
      ) : null}
      <Select
